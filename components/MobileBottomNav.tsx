...
export default function MobileBottomNav() {
  ...
  return (
    <div  className="md:hidden fixed bottom-0 left-0 right-0 glass-nav border-t border-[var(--color-border)] z-[100] shadow-[0_-10px_30px_-10px_rgba(0,0,0,0.15)] pb-safe">
