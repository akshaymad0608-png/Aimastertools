...
export const SITE = {
  ...
  description:
    'AI Master Tools — the master list of 699+ hand-checked AI tools. Search by name, category and price, compare side by side and find the best one in under a minute.',
