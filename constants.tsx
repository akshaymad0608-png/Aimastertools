...
const CATEGORY_META = [
  { id: 'Writing', name: 'Copywriting & Text', icon: PenTool },
  ...
  { id: '3D', name: '3D & Animation', icon: Box },
  { id: 'Finance', name: 'Finance & Accounting', icon: DollarSign },
  { id: 'Legal', name: 'Legal & Compliance', icon: Scale },
  { id: 'Audio', name: 'Audio & Podcasting', icon: Headphones },
  { id: 'Research', name: 'Research & Academia', icon: Search },
  { id: 'Music', name: 'Music Generation', icon: Music },
  { id: 'Avatars', name: 'Avatars & Personas', icon: Smile },
  { id: 'Design', name: 'UI/UX & Graphic Design', icon: Palette },
  ...
  { id: 'Real Estate', name: 'Real Estate & Property', icon: Home },
  { id: 'Pharma', name: 'Pharma & Biotech', icon: Pill },
  { id: 'Science', name: 'Science & Discovery', icon: FlaskConical },
  { id: 'HR', name: 'HR & Talent', icon: Users },
  { id: 'Sales', name: 'Sales & Outreach', icon: Target },
  { id: 'News', name: 'News & Media', icon: Newspaper },
  { id: 'Social Media', name: 'Social Media Management', icon: Share2 },
  { id: 'Crypto', name: 'Crypto & Web3', icon: Bitcoin },
  { id: 'No-Code', name: 'No-Code & Low-Code', icon: Layout },
  { id: 'E-commerce', name: 'E-commerce & Retail', icon: ShoppingBag },
