...
export default function FabSubmit() {
  ...
  return (
    <Link
      to="/submit"
      className={`md:hidden fixed bottom-[88px] right-4 bg-[#534AB7] text-white p-4 rounded-full shadow-lg z-50 flex items-center justify-center transition-all duration-300 ease-in-out ${
