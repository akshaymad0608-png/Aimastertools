...
const CATEGORY_META = [
  { id: 'Writing', name: 'Writing', icon: PenTool, imageUrl: 'https://images.unsplash.com/photo-1517842645767-c639042777db?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Image', name: 'Image', icon: ImageIcon, imageUrl: 'https://images.unsplash.com/photo-1542204165-65bf26472b9b?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Video', name: 'Video', icon: Video, imageUrl: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Coding', name: 'Coding', icon: Code, imageUrl: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Chatbots', name: 'Chatbots', icon: MessageSquare, imageUrl: 'https://images.unsplash.com/photo-1531746790731-6c087fecd65a?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Voice', name: 'Voice', icon: Mic, imageUrl: 'https://images.unsplash.com/photo-1589903308904-1010c2294adc?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Marketing', name: 'Marketing', icon: TrendingUp, imageUrl: 'https://images.unsplash.com/photo-1533750516457-a7f992034fec?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'SEO', name: 'SEO', icon: Globe, imageUrl: 'https://images.unsplash.com/photo-1571844307880-751c6d86f3f3?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Productivity', name: 'Productivity', icon: Zap, imageUrl: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Presentation', name: 'Presentation', icon: Presentation, imageUrl: 'https://images.unsplash.com/photo-1540317580384-e5d43616b9aa?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Business', name: 'Business', icon: Briefcase, imageUrl: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Career', name: 'Career', icon: FileText, imageUrl: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Data', name: 'Data', icon: Database, imageUrl: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Education', name: 'Education', icon: GraduationCap, imageUrl: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: '3D', name: '3D', icon: Box, imageUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Finance', name: 'Finance', icon: DollarSign, imageUrl: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Legal', name: 'Legal', icon: Scale, imageUrl: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Audio', name: 'Audio', icon: Headphones, imageUrl: 'https://images.unsplash.com/photo-1516280440502-a2fc6611d527?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Research', name: 'Research', icon: Search, imageUrl: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Music', name: 'Music', icon: Music, imageUrl: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Avatars', name: 'Avatars', icon: Smile, imageUrl: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Design', name: 'Design', icon: Palette, imageUrl: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Health', name: 'Health', icon: Heart, imageUrl: 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Travel', name: 'Travel', icon: Plane, imageUrl: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Gaming', name: 'Gaming', icon: Gamepad2, imageUrl: 'https://images.unsplash.com/photo-1552820728-8b83bb6b773f?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Fashion', name: 'Fashion', icon: Shirt, imageUrl: 'https://images.unsplash.com/photo-1445205170230-053b83016050?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Real Estate', name: 'Real Estate', icon: Home, imageUrl: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Pharma', name: 'Pharma', icon: Pill, imageUrl: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Science', name: 'Science', icon: FlaskConical, imageUrl: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'HR', name: 'HR', icon: Users, imageUrl: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Sales', name: 'Sales', icon: Target, imageUrl: 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'News', name: 'News', icon: Newspaper, imageUrl: 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Social Media', name: 'Social Media', icon: Share2, imageUrl: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Crypto', name: 'Crypto', icon: Bitcoin, imageUrl: 'https://images.unsplash.com/photo-1518546305927-5a555bb7020d?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'No-Code', name: 'No-Code', icon: Layout, imageUrl: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'E-commerce', name: 'E-commerce', icon: ShoppingBag, imageUrl: 'https://images.unsplash.com/photo-1472851294608-062f824d29cc?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Cybersecurity', name: 'Cybersecurity', icon: Shield, imageUrl: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Personal Assistant', name: 'Assistant', icon: User, imageUrl: 'https://images.unsplash.com/photo-1543269865-cbf427effbad?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Self-Improvement', name: 'Self-Improvement', icon: Sparkles, imageUrl: 'https://images.unsplash.com/photo-1499209974431-9dddcece7f88?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Prompt Engineering', name: 'Prompting', icon: Wand2, imageUrl: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'AI Agents', name: 'AI Agents', icon: Bot, imageUrl: 'https://images.unsplash.com/photo-1531746790731-6c087fecd65a?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Customer Support', name: 'Support', icon: Headset, imageUrl: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Language Translation', name: 'Translation', icon: Languages, imageUrl: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?auto=format&fm=webp&fit=crop&q=80&w=800' },
  { id: 'Student', name: 'Student', icon: BookOpen, imageUrl: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fm=webp&fit=crop&q=80&w=800' },
];
