...
export const CATEGORY_META = [
  ...
  { id: 'Customer Support',          name: 'Customer Support',          icon: 'ti-headphone-alt',  bg: '#EAF3DE', color: '#3B6D11' },
...
},
{
  ...
  },
  {
    id: 'intercom-ai',
    name: 'Intercom AI',
    description: 'Answers customer queries instantly using AI.',
    category: 'Customer Support',
  ...
  },
  {
    id: "zendesk-ai-2",
    name: 'Zendesk AI',
    description: 'Advanced AI bots for quick ticket resolution and self-service.',
    category: 'Customer Support',
  ...
  },
  {
    id: 'kustomer',
    name: 'Kustomer',
    description: 'CRM that leverages AI to proactively resolve support issues.',
    category: 'Customer Support',
    ...
    rating: 4.6,
    featured: true,
    dateAdded: '2026-05-20T10:00:00.000Z',
    tags: ['Customer', 'AI']
  },
  {
    id: 'eightfold',
    name: 'Eightfold',
    description: 'Talent intelligence platform using AI for hiring and retention.',
    ...
    rating: 4.9,
    featured: true,
    dateAdded: '2026-05-22T10:00:00.000Z',
    tags: ['HR', 'AI']
  },
  {
    id: 'seekout',
    name: 'SeekOut',
    description: 'AI-powered recruiting platform to find diverse and hidden talent.',
    category: 'HR & Recruiting',
    ...
    rating: 4.8,
    featured: false,
    dateAdded: '2026-05-10T10:00:00.000Z',
    tags: ['HR', 'AI']
  },
  {
    id: 'textio',
    name: 'Textio',
    description: 'Augmented writing platform that helps write unbiased job descriptions.',
    category: 'HR & Recruiting',
    ...
    rating: 4.5,
    featured: false,
    dateAdded: '2026-05-16T10:00:00.000Z',
    tags: ['HR', 'AI']
  },
  {
    id: 'spline',
    name: 'Spline',
    description: '3D design tool with AI features for web and collaborative modeling.',
    ...
    rating: 4.8,
    featured: false,
    dateAdded: '2026-05-17T10:00:00.000Z',
    tags: ['3D', 'AI']
  },
  {
    id: 'luma-ai',
    name: 'Luma AI',
    description: 'Create life-like 3D models using AI from photos or text.',
    category: '3D & Animation',
  ...
  },
  {
    id: 'masterpiece-x',
    name: 'Masterpiece X',
    description: 'AI text-to-3D model generation for games and creators.',
    category: '3D & Animation',
  ...
  },
  {
    id: 'tableau-gpt',
    name: 'Tableau GPT',
    description: 'AI analytics to democratize data insights using conversational UI.',
    ...
    rating: 4.6,
    featured: true,
    dateAdded: '2026-05-19T10:00:00.000Z',
    tags: ['Data', 'AI']
  },
  {
    id: 'akkio',
    name: 'Akkio',
    description: 'No-code AI platform for forecasting and predictive analytics.',
    category: 'Data Science & Analytics',
    url: 'https://akkio.com',
    domain: 'akkio.com',
    brandColor: '#111827',
  ...
  },
  {
    id: 'julius-ai',
    name: 'Julius AI',
    description: 'Your AI data analyst. Chat with your data and create charts instantly.',
    category: 'Data Science & Analytics',
    url: 'https://julius.ai',
    domain: 'julius.ai',
    brandColor: '#2563EB',
  ...
  },
  {
    id: 'harvey',
    name: 'Harvey',
    description: 'Generative AI for elite law firms to assist in drafting and research.',
  ...
  },
  {
    id: 'robin-ai',
    name: 'Robin AI',
    description: 'Legal copilot for drafting, editing, and querying contracts.',
    category: 'Legal & Compliance',
    ...
    rating: 4.8,
    featured: false,
    dateAdded: '2026-05-15T10:00:00.000Z',
    tags: ['Legal', 'AI']
  },
  {
    id: 'lexion',
    name: 'Lexion',
    description: 'AI-powered contract management system for legal teams.',
    category: 'Legal & Compliance',
    url: 'https://lexion.ai',
    domain: 'lexion.ai',
    brandColor: '#4F46E5',
  ...
  },
  {
    id: 'inworld-ai',
    name: 'Inworld AI',
    description: 'Create intelligent non-player characters (NPCs) for games and VR.',
  ...
  },
  {
    id: 'scenario',
    name: 'Scenario',
    description: 'Train custom AI models to generate game assets consistently.',
    category: 'Gaming & Entertainment',
  ...
  },
  {
    id: 'rosebud-ai',
    name: 'Rosebud AI',
    description: 'AI that helps developers build games from text descriptions.',
    category: 'Gaming & Entertainment',
  ...
  },
  {
    id: 'writesonic',
    name: 'Writesonic',
    description: 'AI writer that creates SEO-friendly content for blogs and ads.',
    category: 'AI Writing & Content',
    ...
    rating: 4.6,
    featured: false,
    dateAdded: '2026-05-11T10:00:00.000Z',
    tags: ['AI', 'AI']
  },
  {
    id: 'rytr',
    name: 'Rytr',
    description: 'An AI writing assistant that helps you create high-quality content.',
    category: 'AI Writing & Content',
    url: 'https://rytr.me',
    domain: 'rytr.me',
    brandColor: '#F59E0B',
  ...
  },
  {
    id: 'anyword',
    name: 'Anyword',
    description: 'AI copywriting software that uses data to optimize conversions.',
    category: 'AI Writing & Content',
  ...
  },
  {
    id: 'heygen',
    name: 'HeyGen',
    description: 'AI video generator for producing studio-quality videos with avatars.',
    category: 'Video & Audio Tools',
  ...
  },
  {
    id: 'descript',
    name: 'Descript',
    description: 'Reimagine video & audio editing as easy as editing a text doc.',
    category: 'Video & Audio Tools',
  ...
  },
  {
    id: 'elevenlabs',
    name: 'ElevenLabs',
    description: 'The most realistic text-to-speech and AI voice generator.',
    category: 'Video & Audio Tools',
  ...
  },
  {
    id: 'github-copilot',
    name: 'GitHub Copilot',
    description: 'Your AI pair programmer that suggests code and entire functions.',
    category: 'Code & Development',
    url: 'https://github.com/features/copilot',
    domain: 'github.com/features/copilot',
    brandColor: '#1F2328',
    imageUrl: 'https://img.logo.dev/github.com/features/copilot?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Paid',
    rating: 4.5,
    featured: false,
    dateAdded: '2026-05-10T10:00:00.000Z',
  ...
  },
  {
    id: 'cursor',
    name: 'Cursor',
    description: 'The AI-first IDE built to help you code faster and smarter.',
    category: 'Code & Development',
    url: 'https://cursor.sh',
    domain: 'cursor.sh',
    brandColor: '#000000',
    imageUrl: 'https://img.logo.dev/cursor.sh?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.6,
    featured: true,
    dateAdded: '2026-05-21T10:00:00.000Z',
  ...
  },
  {
    id: 'tabnine',
    name: 'Tabnine',
    description: 'AI assistant for software developers, prioritizing privacy.',
    category: 'Code & Development',
  ...
  },
  {
    id: 'codeium',
    name: 'Codeium',
    description: 'The modern coding superpower for autocomplete and chat.',
    category: 'Code & Development',
  ...
  },
  {
    id: 'midjourney',
    name: 'Midjourney',
    description: 'An independent research lab producing proprietary artificial intelligence programs that create images from textual descriptions.',
    category: 'Image & Art Generation',
  ...
  },
  {
    id: 'glean',
    name: 'Glean',
    description: 'Workplace search and AI assistant that connects all your company data.',
    category: 'Productivity & Automation',
    url: 'https://glean.com',
    domain: 'glean.com',
    brandColor: '#2563EB',
    imageUrl: 'https://img.logo.dev/glean.com?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Paid',
    rating: 4.9,
    featured: false,
    dateAdded: '2026-05-10T10:00:00.000Z',
  ...
  },
  {
    id: 'notion-ai',
    name: 'Notion AI',
    description: 'Work smart, write faster, and think bigger right inside Notion.',
    category: 'Productivity & Automation',
    url: 'https://notion.so',
    domain: 'notion.so',
    brandColor: '#000000',
  ...
  },
  {
    id: 'mem',
    name: 'Mem',
    description: 'The AI workspace that is personalized to you and your team.',
    category: 'Productivity & Automation',
    url: 'https://mem.ai',
    domain: 'mem.ai',
    brandColor: '#6366F1',
    imageUrl: 'https://img.logo.dev/mem.ai?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.7,
    featured: false,
    dateAdded: '2026-05-15T10:00:00.000Z',
  ...
  },
  {
    id: 'rewind',
    name: 'Rewind',
    description: 'The search engine for your life. Find anything you\'ve seen, said, or heard.',
    category: 'Productivity & Automation',
    url: 'https://rewind.ai',
    domain: 'rewind.ai',
    brandColor: '#8B5CF6',
    imageUrl: 'https://img.logo.dev/rewind.ai?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Paid',
    rating: 4.6,
    featured: false,
    dateAdded: '2026-05-14T10:00:00.000Z',
  ...
  },
  {
    id: "tome-2",
    name: 'Tome',
    description: 'The AI-powered storytelling format to build presentations faster.',
    category: 'Productivity & Automation',
    url: 'https://tome.app',
    domain: 'tome.app',
    brandColor: '#EC4899',
  ...
  },
  {
    id: "gamma-2",
    name: 'Gamma',
    description: 'A new medium for presenting ideas, powered by AI. No formatting needed.',
    category: 'Productivity & Automation',
    url: 'https://gamma.app',
    domain: 'gamma.app',
    brandColor: '#F59E0B',
  ...
  },
  {
    id: 'fireflies-ai',
    name: 'Fireflies.ai',
    description: 'Automate your meeting notes. Record, transcribe, search and analyze voice conversations.',
    category: 'Productivity & Automation',
  ...
  },
  {
    id: 'taskade',
    name: 'Taskade',
    description: 'AI productivity workspace for remote teams. Chat, plan, and work together.',
    category: 'Productivity & Automation',
  ...
  },
  {
    id: 'consensus',
    name: 'Consensus',
    description: 'AI search engine that extracts findings directly from scientific research.',
    category: 'Research & Analysis',
  ...
  },
  {
    id: 'chatprd',
    name: 'ChatPRD',
    description: 'The ultimate copilot for product managers to write PRDs and brainstorm.',
    category: 'Productivity & Automation',
    url: 'https://chatprd.ai',
    domain: 'chatprd.ai',
    brandColor: '#2563EB',
    imageUrl: 'https://img.logo.dev/chatprd.ai?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.8,
    featured: false,
    dateAdded: '2026-05-10T10:00:00.000Z',
  ...
  },
  {
    id: 'figma-ai',
    name: 'Figma AI',
    description: 'AI features woven into Figma to help you design faster and better.',
    category: 'UI/UX & Design Tools',
    url: 'https://figma.com',
    domain: 'figma.com',
    brandColor: '#F24E1E',
  ...
  },
  {
    id: 'framer',
    name: 'Framer',
    description: 'Build stunning websites with AI speed and precision.',
    category: 'UI/UX & Design Tools',
  ...
  },
  {
    id: 'invideo-ai',
    name: 'InVideo AI',
    description: 'Generate publish-worthy videos from text prompts natively with AI.',
    category: 'Video & Audio Tools',
  ...
  },
  {
    id: 'fiscal-ai',
    name: 'Fiscal AI',
    description: 'AI-powered financial modeling and reporting for modern finance teams.',
    category: 'Business & Finance AI',
    url: 'https://fiscal.ai',
    domain: 'fiscal.ai',
    brandColor: '#10B981',
    imageUrl: 'https://img.logo.dev/fiscal.ai?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.8,
    featured: false,
    dateAdded: '2026-05-13T10:00:00.000Z',
  ...
  },
  {
    id: 'koyfin',
    name: 'Koyfin',
    description: 'Financial data and analytics platform providing comprehensive insights.',
    category: 'Business & Finance AI',
    url: 'https://koyfin.com',
    domain: 'koyfin.com',
    brandColor: '#2DD4BF',
    imageUrl: 'https://img.logo.dev/koyfin.com?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.6,
    featured: true,
    dateAdded: '2026-05-20T10:00:00.000Z',
  ...
  },
  {
    id: 'fathom-hq',
    name: 'Fathom HQ',
    description: 'Financial analysis, management reporting and forecasting software.',
    category: 'Business & Finance AI',
  ...
  },
  {
    id: 'tailride',
    name: 'Tailride',
    description: 'Streamlined business solutions and analytics powered by AI.',
    category: 'Business & Finance AI',
    url: 'https://tailride.com',
    domain: 'tailride.com',
    brandColor: '#475569',
    imageUrl: 'https://img.logo.dev/tailride.com?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.9,
    featured: true,
    dateAdded: '2026-05-14T10:00:00.000Z',
  ...
  },
  {
    id: 'zoho-books',
    name: 'Zoho Books',
    description: 'Online accounting software that manages your finances and automates workflows.',
    category: 'Business & Finance AI',
    url: 'https://zoho.com',
    domain: 'zoho.com',
    brandColor: '#F59E0B',
    imageUrl: 'https://img.logo.dev/zoho.com?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.7,
    featured: true,
    dateAdded: '2026-05-16T10:00:00.000Z',
  ...
  },
  {
    id: 'smartscan-ai',
    name: 'SmartScan.ai',
    description: 'AI document scanning and data extraction for receipts and invoices.',
    category: 'Business & Finance AI',
    url: 'https://smartscan.ai',
    domain: 'smartscan.ai',
    brandColor: '#EF4444',
    imageUrl: 'https://img.logo.dev/smartscan.ai?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.7,
    featured: false,
    dateAdded: '2026-05-16T10:00:00.000Z',
  ...
  },
  {
    id: 'expensify',
    name: 'Expensify',
    description: 'Expense management software that uses AI to automate expense reporting.',
    category: 'Business & Finance AI',
    url: 'https://expensify.com',
    domain: 'expensify.com',
    brandColor: '#3E4491',
    imageUrl: 'https://img.logo.dev/expensify.com?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.6,
    featured: false,
    dateAdded: '2026-05-16T10:00:00.000Z',
  ...
  },
  {
    id: 'invoicer-ai',
    name: 'Invoicer.ai',
    description: 'Create professional invoices in seconds with AI-powered invoicing tools.',
    category: 'Business & Finance AI',
    url: 'https://invoicer.ai',
    domain: 'invoicer.ai',
    brandColor: '#4F46E5',
    imageUrl: 'https://img.logo.dev/invoicer.ai?token=pk_Yy124-7wSK-z-Hym446V9A',
    pricing: 'Freemium',
    rating: 4.7,
    featured: true,
    dateAdded: '2026-05-13T10:00:00.000Z',
