...
export const CategorySection: React.FC<CategorySectionProps> = ({ selectedCategory, setSelectedCategory, setSearchTerm, onCategoryClick }) => {
  ...
  return (
    <div className="mb-16 w-full relative">
      ...
      <div className="flex flex-nowrap md:grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-5 overflow-x-auto md:overflow-visible hide-scrollbar pb-6 md:pb-0 snap-x snap-mandatory px-4 md:px-0 -mx-4 md:mx-0">
